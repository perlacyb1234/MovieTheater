...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\programs\\JavaProject\\IdeaProjects\\git_project4v3\\project4\\film\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("liangzhen");
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/guns_cinema?serverTimezone=GMT&characterEncoding=utf8");
