...
public abstract class AbstractGeneratorConfig {
    ...
    public void init() {
        ...
        packageConfig.setService(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".api");
        packageConfig.setServiceImpl(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".api.impl");
